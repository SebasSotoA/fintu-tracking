  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: { value: [host.clientWidth || 1, host.clientHeight || 1] },
        uBlend: { value: blend },
      },
    })
    ...
    // Uniforms refresh each frame from propsRef; recreating the GL context on colorStops identity would flicker.
  }, [amplitude])

  return <div ref={ctnDom} className="aurora-container" aria-hidden />
}
