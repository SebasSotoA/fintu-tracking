...
export function AuthFloatingCard({
  ...
  if (variant === "split") {
    return (
      <div
        className={cn(
          "auth-light grid w-full max-w-4xl overflow-hidden rounded-2xl border border-border bg-white shadow-2xl",
  ...
  return (
    <div
      className={cn(
        "auth-light w-full max-w-md overflow-hidden rounded-2xl border border-border bg-white p-6 shadow-2xl sm:p-7",
        className,
      )}
      {...props}
    >
