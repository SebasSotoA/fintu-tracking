    ...
    <section id="about" className="relative container mx-auto px-6 pb-20 pt-14 md:pb-28 md:pt-20">
      <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div className="max-w-xl landing-fade-up">
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary-container/40 px-3 py-1 text-xs font-medium tracking-wide text-on-primary-container uppercase">
        ...
        <div className="relative mx-auto w-full max-w-md lg:mx-0 lg:ml-auto lg:max-w-none landing-fade-up-delayed">
          <div
            aria-hidden
            className="absolute -inset-4 rounded-3xl border border-primary/10 bg-primary-container/20 blur-2xl landing-float"
          />
          <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-surface-container/80 shadow-2xl shadow-black/40 backdrop-blur-sm landing-float">
            ...
            <div className="space-y-0 divide-y divide-border/40 p-1">
              {precisionMetrics.map((metric, index) => (
                ...
                >
                  ...
                  <span className="font-mono text-[10px] tracking-wide text-on-primary-container uppercase">
                    {metric.delta}
                  </span>
                </div>
              ))}
          ...
          <div
            aria-hidden
            className="absolute -right-3 -bottom-3 hidden h-24 w-24 rounded-xl border border-primary/15 bg-primary-container/30 md:block landing-float-slow"
          />
        </div>
      </div>
    </section>
